// Local brand icons (GitHub, LinkedIn, Instagram, WhatsApp). lucide-react dropped
// brand marks over trademark policy, so rather than ship the whole react-icons
// package for four glyphs we inline their Font Awesome 6 paths here. API mirrors
// lucide: pass `size` (px) and `className`.
...
function BrandSvg({
  ...
  className,
  ...rest
}: BrandIconProps & { viewBox: string; path: string }) {
  return (
    <svg
      width={size}
      height={size}
