...
import {
  ArrowRight, Code2, Database, Server, Gauge, CheckCircle2,
} from "lucide-react";
...
export const metadata: Metadata = {
  title: "About",
  description:
    "Full Stack Engineer based in Jakarta specializing in distributed systems, high-performance APIs, and the interfaces built on top of them.",
  alternates: { canonical: "/about" },
  openGraph: {
    title: "About | M. Daffa Badranthoriq",
    description:
      "Full Stack Engineer based in Jakarta specializing in distributed systems, high-performance APIs, and the interfaces built on top of them.",
    url: "/about",
  },
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* § 1 — HERO (client island for mount animations) */}
      <AboutHero />
